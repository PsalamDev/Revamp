...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230430210529_Added new entity EmailTemplate Process")]
    partial class AddednewentityEmailTemplateProcess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentManagementDomain.Entities.ApplicantJobSearchKeyword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ApplicantJobSearchKeywords");
                });
            ...
            modelBuilder.Entity("RecruitmentManagementDomain.Entities.EmailTemplateProcess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmailTemplateProcesses");
                });
            ...
            modelBuilder.Entity("RecruitmentManagementDomain.Entities.JobScheduleInterview", b =>
                {
                    ...
                    b.HasIndex("HireStageId");

                    b.HasIndex("JobApplicationId");

                    b.HasIndex("SubhireStageId");
            ...
            modelBuilder.Entity("RecruitmentManagementDomain.Entities.ApplicantSkill", b =>
                {
                    b.HasOne("RecruitmentManagementDomain.Entities.ApplicantProfile", null)
            ...
            modelBuilder.Entity("RecruitmentManagementDomain.Entities.JobScheduleInterview", b =>
                {
                    b.HasOne("RecruitmentManagementDomain.Entities.Stage", "HireStage")
                        .WithMany()
                        .HasForeignKey("HireStageId");
                    ...
                    b.HasOne("RecruitmentManagementDomain.Entities.SubStage", "SubhireStage")
                        .WithMany()
                        .HasForeignKey("SubhireStageId");

                    b.Navigation("HireStage");

                    b.Navigation("JobApplication");

                    b.Navigation("SubhireStage");
                });
